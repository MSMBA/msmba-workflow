...
print("Blending:")
print("red and yellow:", end=' ')
z = cdb.blend('red', 'yellow')
print(z)
print("Name of this color according to the database:", end=' ')
closest = cdb.findcolors(z, 1)
print(closest[0][1])

print("2 parts red and 1 part yellow:", end=' ')
...
print("1 part red and 2 parts yellow:", end=' ')
