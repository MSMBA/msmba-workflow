...
# fixed outdated reference to wxPython namespace by importing stc from wx
# changed StyledTextCtrl to StyledTextCtrl and removed wx prefix from stc constants like stc.STC_CMD_LINEEND
