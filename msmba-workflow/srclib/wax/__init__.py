...
from . import core # builtin functions and such
...
import types
classes = [obj for obj in list(globals().values())
           if type(obj) is type and issubclass(obj, WaxObject)]
from . import inject
inject.inject(classes)

#del types, inject, classes, obj
del types, inject, classes
